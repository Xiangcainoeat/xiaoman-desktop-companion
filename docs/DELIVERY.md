...
public/pet/                Runtime artwork, enhanced 90-direction atlas and idle atlas
...
- `release/Xiaoman-Desktop-Companion-1.2.0-arm64.dmg`
- `release/Xiaoman-Desktop-Companion-1.2.0-arm64.zip`
- `release/xiaoman-desktop-companion-source-v1.2.0.zip`
