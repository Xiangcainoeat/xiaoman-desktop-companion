...
from the checked-in runtime atlas. The verifier checks dimensions, frame count,
empty cells, hidden RGB, mid-alpha exposure and native cream-fur color distance.
