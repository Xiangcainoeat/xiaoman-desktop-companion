...
Critical seam constraint: preserve the upper-left gaze in cells 0 through 5 with only tiny pairwise changes. Cells 6 and 7 must be gradual one-third and two-thirds transitions from upper-left toward the final front/up endpoint so the 360-to-0 seam does not snap.
