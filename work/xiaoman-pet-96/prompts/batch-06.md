...
Critical left-zone constraint: all eight cats must preserve the upper-left side gaze in Image 1. Make only the small one-third and two-thirds yaw/eye/ear changes within each pair. Do not invent front-facing or right-facing poses.
