...
com.init = function (stype){
	...
	// Local frame adaptation: keep the visible canvas aligned with each upstream skin's intrinsic surface.
	com.canvas.style.width = com.width + "px";
	com.canvas.style.height = com.height + "px";
	com.canvas.dataset.xiaomanIntrinsicWidth = String(com.width);
	com.canvas.dataset.xiaomanIntrinsicHeight = String(com.height);
